...
impl ::core::fmt::Debug for PublicUser {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("PublicUser")
...
impl PublicUser {
    ...
    pub const TYPE_URL: &'static str = "type.googleapis.com/auth.v2.PublicUser";
}
impl PublicUser {
...
impl ::buffa::DefaultInstance for PublicUser {
    fn default_instance() -> &'static Self {
        static VALUE: ::buffa::__private::OnceBox<PublicUser> = ::buffa::__private::OnceBox::new();
        VALUE.get_or_init(|| ::buffa::alloc::boxed::Box::new(Self::default()))
    }
}
impl ::buffa::MessageName for PublicUser {
...
impl ::buffa::Message for PublicUser {
...
impl ::buffa::ExtensionSet for PublicUser {
    const PROTO_FQN: &'static str = "auth.v2.PublicUser";
...
impl ::buffa::json_helpers::ProtoElemJson for PublicUser {
...
#[doc(hidden)]
pub const __PUBLIC_USER_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/auth.v2.PublicUser",
    to_json: ::buffa::type_registry::any_to_json::<PublicUser>,
    from_json: ::buffa::type_registry::any_from_json::<PublicUser>,
    is_wkt: false,
};
